...
class GazeboEnv:
    ...
    @staticmethod
    def observe_collision(dist_array, orientation_y):
        # print('callback_ orinentation y', orientation_y)
        # Dist array is scaled by DISTANCE_SCALE
        scaled_collision_threshold = COLLISION_DIST
        min_dist = dist_array.min()

        print('min_dist', min_dist)
        print('scaled_collision_threshold', scaled_collision_threshold)
    ...
    def step(self, action):
        # print('ACTION0000000', action[0])
        # print('ACTION1111111111', action[1])
        target = False
        ...
        # Collision detection
        done, collision, min_dist_array = self.observe_collision(self.realsense_data, self.orientation_y)
